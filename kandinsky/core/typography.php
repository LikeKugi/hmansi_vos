...
function knd_inline_style()
{
	...
	$main_color        = get_theme_mod('knd_main_color', '#52a52e');
	$main_color_active = get_theme_mod('knd_main_color_active', '#c9006b');
...
function knd_header_inline_style($css)
{
	...
	$css .= '
:root {
	--knd-header-height: ' . get_theme_mod('header_height', '80px') . ';
...
.knd-header-nav {
	...
	--knd-color-menu-hover: ' . get_theme_mod('header_menu_color_hover', '#c9006b') . ';
}
...
:root {
	...
	--knd-footer-link-color: ' . get_theme_mod('footer_color_link', '#0600ed') . ';
	--knd-footer-link-color-hover: ' . get_theme_mod('footer_color_link_hover', '#c9006b') . ';
}
.knd-footer {
